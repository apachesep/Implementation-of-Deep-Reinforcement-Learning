...
def get_play_args(train_args):
    ...
    parser.add_argument("--env", type=str, default=train_args.env,
    ...
    parser.add_argument("--frames_per_state", type=int, default=train_args.frames_per_state,
    ...
    parser.add_argument("--max_initial_random_steps", type=int, default=10,
                        help="Maximum number of random steps to take at start of episode to ensure random starting point")

    # Files/directories
    parser.add_argument("--ckpt_dir", type=str, default='./ckpts', help="Directory for loading checkpoints")
    parser.add_argument("--ckpt_file", type=str, default=None,
                        help="Checkpoint file to load (if None, load latest ckpt)")
